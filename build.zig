...
pub fn build(b: *std.Build) void {
    ...
    const stl_io_lib = b.addStaticLibrary(.{
        ...
        .root_source_file = b.path("src/stl_io.zig"),
        .target = target,
        .optimize = optimize,
    });
    ...
    // but does not run it.
    const stl_io_lib_unit_tests = b.addTest(.{
        .root_source_file = b.path("src/stl_io.zig"),
        .target = target,
        .optimize = optimize,
    });
    ...
    test_step.dependOn(&run_stl_io_lib_unit_tests.step);
